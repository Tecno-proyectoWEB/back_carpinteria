...
class MenuController extends Controller
{
    ...
    public function getMenuForUser($user)
    {
        ...
        // Fallback: menú hardcodeado mientras se configura en BD
        ...
        switch ($rolNombre) {
            case 'PROPIETARIO':
                $menu = array_merge($menu, [
                    ...
                    ['id' => 5, 'nombre' => 'Ventas', 'ruta' => route('ventas.index'), 'icono' => 'shopping-cart', 'orden' => 5, 'children' => []],
                    ['id' => 6, 'nombre' => 'Pagos', 'ruta' => route('pagos.index'), 'icono' => 'credit-card', 'orden' => 6, 'children' => []],
                    ...
                    ['id' => 9, 'nombre' => 'Roles', 'ruta' => route('roles.index'), 'icono' => 'shield', 'orden' => 9, 'children' => []],
                ]);
                break;
            ...
            case 'CLIENTE':
                $menu = array_merge($menu, [
                    ['id' => 2, 'nombre' => 'Productos', 'ruta' => route('productos.index'), 'icono' => 'box', 'orden' => 2, 'children' => []],
                    ['id' => 3, 'nombre' => 'Servicios', 'ruta' => route('servicios.index'), 'icono' => 'tools', 'orden' => 3, 'children' => []],
                    ['id' => 10, 'nombre' => 'Mis Ventas', 'ruta' => route('ventas.mis-ventas'), 'icono' => 'list', 'orden' => 10, 'children' => []],
                ]);
                break;
        }
