                ...
                <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <div class="px-6 py-5 bg-gradient-to-r from-indigo-600 to-blue-600 text-white flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-indigo-100 mt-1">{{ producto?.categoria?.nombre || 'Sin categor├¡a' }}</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                <div class="bg-gray-50 rounded-lg p-5 border border-gray-200">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            <label class="text-sm font-medium text-gray-500 block mb-1">Descripci├│n</label>
                                            <p class="text-gray-900">{{ producto?.descripcion || 'Sin descripci├│n' }}</p>
                                        </div>
                                        <div>
                                            <label class="text-sm font-medium text-gray-500 block mb-1">Categor├¡a</label>
                                            <p class="mt-1">
                                                <Badge variant="info" class="text-sm px-3 py-1">{{ producto?.categoria?.nombre || 'Sin categor├¡a' }}</Badge>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gray-50 rounded-lg p-5 border border-gray-200">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            >
                                                {{ producto?.stock || 0 }}
                                                <span v-if="(producto?.stock || 0) <= (producto?.stock_minimo || 0)" class="text-xs">ÔÜá´©Å Stock bajo</span>
                                            </p>
                                        </div>
                                        <div>
                                            <label class="text-sm font-medium text-gray-500 block mb-1">Stock M├¡nimo</label>
