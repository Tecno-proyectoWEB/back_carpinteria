                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                        ...
                        <p class="text-gray-600 text-sm">
                            An├ílisis detallado de ventas, productos m├ís vendidos y rendimiento por vendedor
                        </p>
                    </Link>
                    ...
                    >
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">Reporte de Compras</h3>
                        <p class="text-gray-600 text-sm">
                            An├ílisis de compras, materiales m├ís comprados y gastos por proveedor
                        </p>
                    </Link>
                    ...
                    >
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">Reporte de Inventario</h3>
                        <p class="text-gray-600 text-sm">
                            Stock bajo, movimientos de inventario y an├ílisis de existencias
                        </p>
                    </Link>
                </div>
            </div>
