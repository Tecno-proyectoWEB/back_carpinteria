...
const form = useForm({
    ...
    categoria_id: props.servicio?.categoria_id || null,
    precio_base: props.servicio?.precio_base || 0,
    tiempo_estimado: props.servicio?.tiempo_estimado || null,
...
const submit = () => {
    ...
    form.post(getRoute('servicios.update', props.servicio.id));
};
</script>
