            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                    <div class="px-6 py-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900">Detalle de la Bit├ícora</h2>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        <label class="text-sm font-medium text-gray-500">Acci├│n</label>
                            ...
                            <!-- Detalles T├®cnicos -->
                            <div>
                                <h3 class="text-lg font-semibold mb-4">Detalles T├®cnicos</h3>
                                <div class="space-y-3">
                                    <div>
                                    ...
                                    <div>
                                        <label class="text-sm font-medium text-gray-500">Direcci├│n IP</label>
