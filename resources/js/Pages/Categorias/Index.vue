        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <DataTable
                    ...
                    :paginated="false"
                >
                    <template #cell-subcategoria="{ row }">
                        <Badge v-if="row.subcategoria" variant="info">
                    ...
                    <template #actions="{ row }">
                        <Link
                            :href="route('categorias.show', row.id)"
                        ...
                        <Link
                            v-if="canEdit"
                            :href="route('categorias.edit', row.id)"
                ...
                <!-- Paginación -->
                <div v-if="categorias.links" class="mt-4">
                    <div class="flex justify-center">
                        <div v-for="link in categorias.links" :key="link.label">
                            <Link
                                v-if="link.url"
                                :href="link.url"
                                v-html="link.label"
...
const columns = [
    ...
    { key: 'subcategoria', label: 'Subcategoría', sortable: false },
...
const applyFilters = () => {
    router.get(route('categorias.index'), filters.value, {
        preserveState: true,
        preserveScroll: true,
    });
};
